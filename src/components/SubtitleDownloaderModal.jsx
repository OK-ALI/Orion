      ...
      >
        ...
        >
          ...
          <div style={{ flex: 1, overflowY: "auto" }}>
            {/* Detailed visual key onboarding/guidance */}
            {!wyzieApiKey && !subdlApiKey && wyzieApiKey !== null && (
              ...
              >
                <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
                  <span style={{ fontSize: 24, filter: "drop-shadow(0 0 6px var(--accent))" }}>🔑</span>
                  <div>
                    <h4 style={{ margin: 0, fontSize: 14, fontWeight: 600, color: "var(--text)" }}>
                      Subtitle Services Setup Required
                    </h4>
                    <p style={{ margin: "2px 0 0", fontSize: 12, color: "var(--text3)" }}>
                      Orion searches subtitles from SubDL and Wyzie. Please set up at least one API key.
                    </p>
                  </div>
                </div>
                ...
                <div style={{ borderTop: "1px solid var(--border)", paddingTop: 14 }}>
                  <div style={{ display: "flex", flexDirection: "column", gap: 12 }}>
                    ...
                    <div style={{ display: "flex", gap: 10, alignItems: "flex-start" }}>
                      <span style={{ fontSize: 14, color: "#6395ff", marginTop: -2 }}>●</span>
                      <div style={{ flex: 1 }}>
                        <div style={{ fontWeight: 600, color: "var(--text)", fontSize: 13 }}>
                          SubDL Key (Free Subtitles)
                        </div>
                        <div style={{ fontSize: 12, color: "var(--text2)", marginTop: 2, lineHeight: 1.5 }}>
                          Free subtitle database. Create a free account at SubDL, go to your API profile, and copy your API token.
                        </div>
                        <button
                          className="btn btn-ghost"
                          style={{
                    ...
                    <div style={{ display: "flex", gap: 10, alignItems: "flex-start", marginTop: 4 }}>
                      <span style={{ fontSize: 14, color: "#b482ff", marginTop: -2 }}>●</span>
                      <div style={{ flex: 1 }}>
                        <div style={{ fontWeight: 600, color: "var(--text)", fontSize: 13 }}>
                          Wyzie Key (High-Speed Translations)
                        </div>
                        <div style={{ fontSize: 12, color: "var(--text2)", marginTop: 2, lineHeight: 1.5 }}>
                          Premium translate and sync services. Access store.wyzie.io, redeem your subscription, and copy your API key.
                        </div>
                        <button
                          className="btn btn-ghost"
                          style={{
                          ...
                          onClick={() => window.electron?.wyzieOpenRedeem()}
                        >
                          Open Wyzie Store ↗
                        </button>
                      </div>
                ...
                >
                  {onOpenSettings && (
                    ...
                    >
                      <SettingsIcon size={14} /> Configure Keys in Settings
                    </button>
                  )}
                </div>
              </div>
