...
export const THEME_PRESETS = [
  {
    id: "dark",
    label: "Cosmic",
    description: "Orion's ink, violet and spectral dark theme",
    vars: {
      "--bg-base": "#070914",
      "--bg-elevated": "#0e1224",
      "--bg-surface": "#151a31",
  ...
  },
  {
    id: "light",
    label: "Orion Day",
    description: "Pale blue-grey surfaces with high-contrast typography",
    vars: {
      "--bg-base": "#e9eef7",
      "--bg-elevated": "#f8faff",
      "--bg-surface": "#eef3fb",
      ...
      "--bg-input": "#ffffff",
      "--text-primary": "#101528",
      "--text-secondary": "#39435d",
      "--text-muted": "#626d87",
      "--border": "rgba(35, 48, 79, 0.16)",
    },
  },
  {
    id: "custom",
