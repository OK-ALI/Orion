...
// ── Search & Nav Bar ──────────────────────────────────────────────────────────
function tmdbTokenDetail(source) {
  if (source === "user") return "User configured";
  if (source === "bundled") return "Bundled";
  return "Required for metadata, posters, and search";
}

function SystemCheckSection({ apiKey, apiKeySource = "missing", downloadPath }) {
  const [status, setStatus] = useState(null);
    ...
    <>
      ...
      >
        ...
        <div ref={secLibrary} style={{ scrollMarginTop: 80 }}>
          <SectionGroupHeader
            title="Library"
            subtitle="My List sort order and watch history preferences"
          />
          ...
          >
            ...
            <div style={{ padding: "22px 24px" }}>
              <CleanRow
                ...
                description="Opens the folder where Orion is installed."
            ...
            <div style={{ padding: "22px 24px" }}>
              <CleanRow
                title="Delete All Downloads"
                description="Permanently deletes all video files that were downloaded through Orion and removes them from the download list. Only files downloaded through the app will be deleted, nothing else in your folder is touched."
