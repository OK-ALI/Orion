...
const legacyFolderCleanup = require("./005_legacy_duplicate_empty_playlist_folders");
const { MUSIC_SCHEMA_VERSION } = require("../../../shared/musicConstants.cjs");

const migrations = [initial, artworkCache, fileIdentity, playlistFolders, legacyFolderCleanup].sort((a, b) => a.version - b.version);
