const catalog = Object.freeze([
  { id: "orion-core", name: "Orion Music Core", description: "Local library, media controls and secure playback grants.", categories: ["metadata", "streaming", "other"], version: "2.0.1", bundled: true, locked: true, defaultInstalled: true, permissions: ["library:read", "playback:resolve"] },
