...
export const createConnectRemoteStyles = (theme: MobileThemeTokens) => StyleSheet.create({
  ...
  scrubberContainer: { width: '100%', marginBottom: 8 },
  ...
  scrubberHitTarget: { width: '100%', height: 30, justifyContent: 'center' },
  scrubberTrack: { width: '100%', height: 7, borderRadius: 4, backgroundColor: theme.border, overflow: 'hidden' },
  scrubberBuffered: { position: 'absolute', top: 0, bottom: 0, left: 0, height: '100%', backgroundColor: theme.textMuted, opacity: 0.35, borderRadius: 4 },
  scrubberFill: { position: 'absolute', left: 0, height: '100%', backgroundColor: theme.accent, borderRadius: 4 },
  scrubberThumb: { position: 'absolute', top: 7, width: 16, height: 16, marginLeft: -8, borderRadius: 8, backgroundColor: theme.accent, borderWidth: 3, borderColor: theme.surface },
