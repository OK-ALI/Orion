...
export const createConnectStyles = (theme: MobileThemeTokens) => {
  ...
  modalTextAction: { minHeight: 44, paddingHorizontal: spacing[3], alignItems: 'center', justifyContent: 'center' },
  modalTextActionLabel: {
    color: theme.accent,
    fontSize: 13,
    fontWeight: '800',
  },
  modalTextActionSmall: {
    color: theme.textSecondary,
    fontSize: 12,
    fontWeight: '700',
  },
  ...
  ...createConnectRemoteStyles(theme),
  });
};
