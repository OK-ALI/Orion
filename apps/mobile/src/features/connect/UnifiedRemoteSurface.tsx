      ...
      <View style={styles.systemRow}>
        ...
        {brightnessSupported ? (
          ...
          <Text style={styles.unsupportedNotice}>
            DDC/CI hardware brightness control is not supported on this monitor.
          </Text>
        )}
      </View>
    </View>
...
function createStyles(theme: any) {
  return StyleSheet.create({
    root: { paddingHorizontal: 18, paddingBottom: 44, gap: 14 },
    ...
    playbackCard: { padding: 14, borderRadius: 22, backgroundColor: theme.surface, borderWidth: 1, borderColor: theme.border, gap: 8 },
    contextCard: { padding: 16, borderRadius: 22, backgroundColor: theme.surface, borderWidth: 1, borderColor: theme.border },
    ...
    action: { minWidth: 58, minHeight: 48, paddingHorizontal: 10, paddingVertical: 7, borderRadius: 16, alignItems: 'center', justifyContent: 'center', gap: 3, backgroundColor: theme.elevated, borderWidth: 1, borderColor: theme.border },
    actionLabel: { color: theme.text, fontSize: 10, fontWeight: '700' },
    pressed: { opacity: 0.78, transform: [{ scale: 0.97 }] },
    disabled: { opacity: 0.42 },
    touchpadBlock: { gap: 9, flex: 1 },
    ...
    rail: { flexDirection: 'row', gap: 9, paddingVertical: 2 },
    ...
    systemCard: { padding: 14, borderRadius: 22, backgroundColor: theme.surface, borderWidth: 1, borderColor: theme.border, gap: 12 },
