...
export default function MediaDetailScreen() {
  ...
  // Tab Transition Cross-Fade Animation
  ...
  // Desktop Parity: Unreleased & Strict Trailer checks (Trailers & Teasers ONLY)
  ...
  for (const v of combinedVideos) {
    if (v.site === 'YouTube' && !seenKeys.has(v.key)) {
      ...
      // Strictly include official Trailers and Teasers only
      const isOfficialType = type === 'Trailer' || type === 'Teaser';

      // Comprehensive exclusion list for non-trailers (behind the scenes, clips, spots, interviews, announcements)
    ...
    <View style={styles.container}>
      ...
      <Animated.ScrollView style={{ flex: 1 }} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.backdropContainer}>
          ...
          {/* Cinematic Dark Gradient Fade for Text Contrast */}
          <LinearGradient
        ...
        <View style={styles.detailsContent}>
          ...
          <View style={styles.tabContent}>
            {/* Overview & Selectable Top Cast Tab */}
            {activeTab === 'info' && (
            ...
            {/* Rich TV Episodes List Tab (Desktop Parity!) */}
            {activeTab === 'episodes' && (
              <View style={styles.episodesListContainer}>
                ...
                {episodesLoading ? (
                  ...
                  episodes.map((ep: any) => (
                    ...
                    >
                      {/* Episode Thumbnail with Play Badge Overlay */}
                      ...
                      <View style={styles.episodeListInfo}>
                        ...
                        {/* Episode Synopsis Plot Overview (Desktop Parity!) */}
                        {!!ep.overview && (
